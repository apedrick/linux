...
#define MAX1363_CHAN_U(num, addr, si, bits, evspec, nevspec)		\
	{								\
		.type = IIO_VOLTAGE,					\
		.indexed = 1,						\
		.channel = num,						\
		...
		.scan_index = si,					\
		.event_spec = evspec,					\
		.num_event_specs = nevspec,				\
	}

/* bipolar channel */
#define MAX1363_CHAN_B(num, num2, addr, si, bits, evspec, nevspec)	\
	{								\
		.type = IIO_VOLTAGE,					\
		.differential = 1,					\
		.indexed = 1,						\
...
#define MAX1363_4X_CHANS(bits, es, nes) {		\
	MAX1363_CHAN_U(0, _s0, 0, bits, es, nes),	\
	MAX1363_CHAN_U(1, _s1, 1, bits, es, nes),	\
	MAX1363_CHAN_U(2, _s2, 2, bits, es, nes),	\
	MAX1363_CHAN_U(3, _s3, 3, bits, es, nes),	\
	MAX1363_CHAN_B(0, 1, d0m1, 4, bits, es, nes),	\
	MAX1363_CHAN_B(2, 3, d2m3, 5, bits, es, nes),	\
	MAX1363_CHAN_B(1, 0, d1m0, 6, bits, es, nes),	\
	MAX1363_CHAN_B(3, 2, d3m2, 7, bits, es, nes),	\
	IIO_CHAN_SOFT_TIMESTAMP(8)			\
	}

static struct iio_chan_spec max1036_channels[] = MAX1363_4X_CHANS(8, NULL, 0);
static struct iio_chan_spec max1136_channels[] = MAX1363_4X_CHANS(10, NULL, 0);
static struct iio_chan_spec max1236_channels[] = MAX1363_4X_CHANS(12, NULL, 0);
